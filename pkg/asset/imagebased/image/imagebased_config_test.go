...
`,
		...
		},
		{
			...
			expectedFound: false,
			expectedError: "failed to unmarshal imagebased-installation-config.yaml: error unmarshaling JSON: while decoding JSON: json: cannot unmarshal string into Go value of type imagebased.InstallationConfig",
		},
		{
			name:       "file-not-found",
		...
		},
		{
			...
			expectedFound: false,
			expectedError: "failed to load imagebased-installation-config.yaml file: fetch failed",
		},
		{
			name: "unknown-field",
			data: `
...
wrongField: wrongValue`,
			...
			expectedFound: false,
			expectedError: "failed to unmarshal imagebased-installation-config.yaml: error unmarshaling JSON: while decoding JSON: json: unknown field \"wrongField\"",
		},
		{
...
func (icb *ImageBasedInstallationConfigBuilder) proxy(proxy *types.Proxy) *ImageBasedInstallationConfigBuilder {
	icb.InstallationConfig.Proxy = proxy
	return icb
}
...
func (icb *ImageBasedInstallationConfigBuilder) deprecatedImageContentSources(ics []types.ImageContentSource) *ImageBasedInstallationConfigBuilder {
	icb.InstallationConfig.DeprecatedImageContentSources = ics
	return icb
}
