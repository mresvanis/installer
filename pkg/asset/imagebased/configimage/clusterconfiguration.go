...
func (cc *ClusterConfiguration) Generate(dependencies asset.Parents) error {
	...
	cc.Config = &lca.SeedReconfiguration{
		// TODO: uncomment when https://github.com/openshift-kni/lifecycle-agent/pull/499 is merged
		// AdditionalTrustBundle: (lca.PEM)installConfig.Config.AdditionalTrustBundle,
		//
		// TODO: add ChronyConfig when https://github.com/openshift-kni/lifecycle-agent/pull/524 is merged
		// ChronyConfig: imagebased.Config.ChronyConfig.String(),
